...
const data = [{ id: uniqueId('skill-'), name: 'Vue.js', icon: 'fab fa-vuejs', stars: 4 },
{ id: uniqueId('skill-'), name: 'JavaScript', icon: 'fab fa-js', stars: 4 },
{ id: uniqueId('skill-'), name: 'React.js', icon: 'fab fa-react', stars: 2 },

<template>
    <div class="w-full p-1 px-0 mx-6">
        <a :href="url" target="_blank">
            ...
            <div class="'flex items-center px-3 py-4 border border-gray-800 rounded-lg bg-gradient-to-r from-purple-400 to-red-500 hover:bg-indigo-500 hover:bg-opacity-10 hover:shadow-lg hover:border-indigo-500'">
                <div class="flex-grow ">
